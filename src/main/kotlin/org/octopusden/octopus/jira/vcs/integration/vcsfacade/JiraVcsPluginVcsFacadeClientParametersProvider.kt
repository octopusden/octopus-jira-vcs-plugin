...
@Named
class JiraVcsPluginVcsFacadeClientParametersProvider(
    ...
    override fun getTimeRetryInMillis(): Int = pluginSettings.getString(PluginProperty.VCS_FACADE_RETRY_DELAY_MILLIS).toInt()
}
